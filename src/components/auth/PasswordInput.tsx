...
export function PasswordInput({
    ...
    return (
        ...
        <div className="relative">
            ...
            className="w-full rounded-xl border-0 bg-surface-2 py-3.5 pl-12 pr-14 text-text outline-none transition focus:shadow-[inset_2px_2px_6px_rgba(20,80,143,0.2),inset_-2px_-2px_6px_rgba(255,255,255,0.9)] focus:ring-2 focus:ring-primary/30"
            />
            <button
            type="button"
